...
When getting this working, sending emails may prove tricky: it's an area where abusers are always coming up with new tricks, and the email providers always having to impose new restrictions to counter them. This is why we can't have nice things. If you run into trouble here, I recommend consulting ChatGPT.
